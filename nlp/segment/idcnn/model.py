...
from nlp.segment.idcnn.utils import result_to_sentence
...
class Model(object):
    def __init__(self, config):
        ...
        with tf.variable_scope("char_embedding"), tf.device('/cpu:0'):
            ...
            embedding = tf.nn.embedding_lookup(self.char_lookup, self.char_inputs)
    ...
    def evaluate_line(self, sess, inputs, id_to_tag):
        ...
        return result_to_sentence(inputs[0][0], tags)